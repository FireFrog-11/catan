...
class CatanState(GameState):
    def enter(self):
        ...
        self.build_road_button = Button(name="build_road_button", pos=(25, 75), size=(75, 75), colour=(255,0,0), action=self.build_road_button_function, border_radius=8, border_colour=(255,0,0), border_width=8)
        ...
        self.build_settlement_button = Button(name="build_settlement_button", pos=(25, 215), size=(75, 75), colour=(255,0,0), action=self.build_settlement_button_function, border_radius=8, border_colour=(255,0,0), border_width=8)
        ...
        self.build_city_button = Button(name="build_city_button", pos=(25, 355), size=(75, 75), colour=(255,0,0), action=self.build_city_button_function, border_radius=8, border_colour=(255,0,0), border_width=8)
        ...
        self.build_devcard_button = Button(name="build_devcard_button", pos=(25, 495), size=(75, 75), colour=(255,0,0), action=self.build_devcard_button_function, border_radius=8, border_colour=(255,0,0), border_width=8)
        ...
        # end button
        self.end_button = Button(name="end_button", pos=(1425, 762.5), size=(100, 100), colour=(255,0,0), action=self.end_button_function, border_radius=8, border_colour=(255,0,0), border_width=8, text="End Turn", text_colour=(255,255,255), text_size=25, bold=True)
        ui_manager.add_component(self.end_button)

        # trade button
        self.trade_button = Button(name="trade_button", pos=(1300, 762.5), size=(100, 100), colour=(0,255,0), action=self.trade_button_function, border_radius=8, border_colour=(0,255,0), border_width=8, text="Trade", text_colour=(255,255,255), text_size=25, bold=True)
        ui_manager.add_component(self.trade_button)

        # use dev-card button
        self.devcard_button = Button(name="devcard_button", pos=(1175, 762.5), size=(100, 100), colour=(255,165,0), action=self.build_road_button_function, border_radius=8, border_colour=(255,165,0), border_width=8, text="Devcard", text_colour=(255,255,255), text_size=25, bold=True)
